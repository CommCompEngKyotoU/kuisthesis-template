...
\etitle{How to Write Your B.E. Thesis}	% English title.
\eauthor{Kohei Suenaga}			% Author name in English
\jauthor{末永 幸平}			% Author name in Japanese. If you are an international student, this can be the same as the \eauthor.
...

\nocite{*}
\bibliographystyle{kuissort}			% BibTeX style
